...
"{RsrcDir}SWIMIOP.rsrc"		ƒ	"{ObjDir}SWIMIOP.BIN"								∂
								"{RsrcDir}MakeIOPCRes"
	"{RsrcDir}MakeIOPCRes" -r "{Targ}" -s 16384 -i 1 -o 1 -b "{ObjDir}SWIMIOP.BIN"


"{RsrcDir}SCCIOP.rsrc"		ƒ	"{ObjDir}SCCIOP.BIN"								∂
								"{RsrcDir}MakeIOPCRes"
	"{RsrcDir}MakeIOPCRes" -r "{Targ}" -s 3072 -i 0 -o 1 -b "{ObjDir}SCCIOP.BIN"


"{ObjDir}SWIMIOP.BIN"		ƒ	"{ObjDir}SWIMIOP.load"
	MakeBinIIGS "{ObjDir}SWIMIOP.load" -o "{Targ}"


"{ObjDir}SCCIOP.BIN"		ƒ	"{ObjDir}SCCIOP.load"
	MakeBinIIGS "{ObjDir}SCCIOP.load" -o "{Targ}"


"{ObjDir}SWIMIOP.load"		ƒ	"{ObjDir}IOPKernel.aii.obj"							∂
...
"{ObjDir}SCCIOP.load"		ƒ	"{ObjDir}SCCIOP.aii.obj"
...
"{ObjDir}IOPKernel.aii.obj"		ƒ	"{IOPDir}IOPDefs.aii"							∂
									"{IOPDir}IOPKernel.aii"
	AsmIIGS -o "{Targ}" "{IOPDir}IOPKernel.aii"



"{ObjDir}SWIMIOP.aii.obj"		ƒ	"{IOPDir}IOPDefs.aii"							∂
									"{IOPDir}SWIMDefs.aii"							∂
									"{IOPDir}SWIMIOP.aii"
...
"{ObjDir}SWIMDriver.aii.obj"	ƒ	"{IOPDir}IOPDefs.aii"							∂
									"{IOPDir}SWIMDefs.aii"							∂
...
"{ObjDir}ADBDriver.aii.obj"		ƒ	"{IOPDir}IOPDefs.aii"							∂
									"{IOPDir}SWIMDefs.aii"							∂
...
"{ObjDir}SCCIOP.aii.obj"		ƒ	"{IOPDir}SCCIOPEqu.aii"							∂
