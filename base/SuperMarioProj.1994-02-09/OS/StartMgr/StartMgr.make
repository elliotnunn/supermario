...
"{LibDir}StartTest.lib"		ƒ	{StartTestObjs}
...
"{ObjDir}StartTop.a.o"		ƒ	"{StartDir}StartTop.a"
...
"{ObjDir}ExceptionSupport.a.o" ƒ "{StartDir}ExceptionSupport.a"					∂
...
"{ObjDir}UTEKernel.c.o"				ƒ	"{StartDir}UnivTestEnv:BitWalk.c"			∂
...
"{ObjDir}SONIC_Test.c.o"			ƒ	"{StartDir}UnivTestEnv:SONIC_Test.c"		∂
