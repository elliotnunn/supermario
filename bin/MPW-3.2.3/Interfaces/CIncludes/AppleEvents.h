...
pascal OSErr AECoercePtr(DescType typeCode,Ptr dataPtr,Size dataSize,DescType toType,
    AEDesc *result)
...
pascal OSErr AECreateList(Ptr factoringPtr,Size factoredSize,Boolean isRecord,
...
pascal OSErr AEInteractWithUser(long timeOutInTicks,NMRecPtr nmReqPtr,IdleProcPtr idleProc)
